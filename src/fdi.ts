...
const FDI_BABY_TEETH_UPPER_LEFT = [55, 54, 53, 52, 51] as const;
const FDI_BABY_TEETH_UPPER_RIGHT = [61, 62, 63, 64, 65] as const;
const FDI_BABY_TEETH_UPPER = [
  ...FDI_BABY_TEETH_UPPER_LEFT,
  ...FDI_BABY_TEETH_UPPER_RIGHT
] as const;

const FDI_BABY_TEETH_LOWER_LEFT = [85, 84, 83, 82, 81] as const;
const FDI_BABY_TEETH_LOWER_RIGHT = [71, 72, 73, 74, 75] as const;
