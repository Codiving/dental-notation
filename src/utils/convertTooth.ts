...
export function convertTooth(teeth: FdiTeeth[], to: "palmer"): PalmerTeeth[];

export function convertTooth(teeth: UniversalTeeth[], to: "fdi"): FdiTeeth[];
...
export function convertTooth(teeth: PalmerTeeth[], to: "fdi"): FdiTeeth[];
